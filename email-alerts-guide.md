...
Only alerts with level ≥ 12 will trigger an email unless a rule contains the 

```
<options>alert_by_email</options> flag.
```
...
In your local rules, you can add

```
 <options>no_email_alert</options> to suppress noise.
```
